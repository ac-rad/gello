...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    # Left UR
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTA7NN89-if00-port0": DynamixelRobotConfig(
    ...
    # Right UR
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTA7NNQU-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            4 * np.pi/2,
            1 * np.pi / 2,
